...
@Component({
  selector: "app-receipt-entry-table",
  templateUrl: "./receipt-entry-table.component.html",
  styleUrls: ["./receipt-entry-table.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReceiptEntryTableComponent implements OnInit {
  ...
  public columns = [
    { name: "ID", prop: "id" },
    { name: "amountType", prop: "amountType" },
    { name: "amount", prop: "amount" },
    { name: "totalAmount", prop: "totalAmount" },
    { name: "entryDate", prop: "entryDate" },
  ...
  getAllReceipt(){
    ...
    this.receiptService.getAllReceipt().subscribe((ok:any)=>{
      this.rows = ok;
