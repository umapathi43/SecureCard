export const LISTITEMS: any[] = [
  ...
  { url: "/forgotpassword", name: "Forgot Password", icon: "ft-alert-octagon" },
  { url: "/login", name: "Login", icon: "ft-log-in" },
  { url: "/register", name: "Register", icon: "ft-user-plus" },
  { url: "/lockscreen", name: "Lock Screen", icon: "ft-lock" },
  {
    url: "/horizontaltimeline",
    name: "Horizontal Timeline",
    icon: "ft-credit-card",
  },
  {
    url: "/timeline-vertical-center",
    name: "Vertical Timeline Center",
    icon: "ft-sidebar",
  },
  {
    url: "/timeline-vertical-left",
    name: "Vertical Timeline Left",
    icon: "ft-sidebar",
  },
  {
    url: "/timeline-vertical-right",
    name: "Vertical Timeline Right",
    icon: "ft-sidebar",
  },
  { url: "/account-settings", name: "Account Settings", icon: "ft-settings" },
  { url: "/profile", name: "User Profile", icon: "ft-user" },
  { url: "/invoice", name: "Invoice", icon: "ft-file-text" },
  { url: "/error", name: "Error", icon: "ft-alert-triangle" },
  { url: "/comingsoon", name: "Coming Soon", icon: "ft-clock" },
  { url: "/maintenance", name: "Maintenance", icon: "ft-settings" },
  { url: "/gallery", name: "Gallery", icon: "ft-image" },
  { url: "/search", name: "Search", icon: "ft-search" },
  { url: "/faq", name: "FAQ", icon: "ft-help-circle" },
  { url: "/kb", name: "Knowledge Base", icon: "ft-info" },
  { url: "/users-list", name: "Users List", icon: "ft-search" },
  { url: "/users-view", name: "Users View", icon: "ft-search" },
  { url: "/users-edit", name: "Users Edit", icon: "ft-search" },
];
