...
@Component({
  selector: "app-discountslab",
  templateUrl: "./discountslab.component.html",
  styleUrls: [
    "./discountslab.component.scss",
    "../../assets/sass/libs/datatables.scss",
  ],
  encapsulation: ViewEncapsulation.None,
})
export class DiscountslabComponent implements OnInit {
  ...
  Confirm(data: any) {
    ...
    swal
      ...
      .then(function (result) {
        if (result.value) {
          data['status']="D";
          that._discountService.updateDiscount(data).subscribe((ok) => {
            console.log(ok);
            swal.fire({
              icon: "success",
              title: "Deleted!",
  ...
  exportExcel() {
    ...
    this.saveAsExcelFile(excelBuffer, "discountslab");
  }
