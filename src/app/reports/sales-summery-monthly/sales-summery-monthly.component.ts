...
export class SalesSummeryMonthly {
  public itemName: any;
  public group: string;
...
@Component({
  selector: 'app-sales-summery-monthly',
  templateUrl: './sales-summery-monthly.component.html',
  styleUrls: ['./sales-summery-monthly.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SalesSummeryMonthlyComponent implements OnInit {

  model = new SalesSummeryMonthly();
  CustomeId: any;
  itemArray: any[];
