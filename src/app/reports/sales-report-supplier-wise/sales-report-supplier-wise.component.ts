...
export class SalesReportSupplierWise {
  public itemName: any;
  public group: string;
...
@Component({
  selector: 'app-sales-report-supplier-wise',
  templateUrl: './sales-report-supplier-wise.component.html',
  styleUrls: ['./sales-report-supplier-wise.component.scss'
  ],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})

export class SalesReportSupplierWiseComponent implements OnInit {
  model = new SalesReportSupplierWise();
  CustomeId: any;
  itemArray: any[];
