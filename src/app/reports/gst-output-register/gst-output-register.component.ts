...
@Component({
  selector: 'app-gst-output-register',
  templateUrl: './gst-output-register.component.html',
  styleUrls: ['./gst-output-register.component.scss'],
