...
@Component({
  selector: 'app-gst-input-register',
  templateUrl: './gst-input-register.component.html',
  styleUrls: ['./gst-input-register.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GstInputRegisterComponent implements OnInit {

  model = new GstInputRegister();
  CustomeId: any;
  itemArray: any[];
