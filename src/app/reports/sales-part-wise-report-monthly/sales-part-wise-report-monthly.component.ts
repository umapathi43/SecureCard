...
@Component({
  selector: "app-sales-part-wise-report-monthly",
  templateUrl: "./sales-part-wise-report-monthly.component.html",
  styleUrls: ["./sales-part-wise-report-monthly.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class SalesPartWiseReportMonthlyComponent implements OnInit {
  public limitRef = 10;
  ...
  detailsPage(event) {
    if (event.type == "click") {
      this.route.navigate(["/reports/detail", event.row.id]);
