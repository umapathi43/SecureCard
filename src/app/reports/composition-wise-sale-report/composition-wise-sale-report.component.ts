...
export class CompositionWiseSaleReport {
  public itemName: any;
  public group: string;
...
@Component({
  selector: 'app-composition-wise-sale-report',
  templateUrl: './composition-wise-sale-report.component.html',
  styleUrls: ['./composition-wise-sale-report.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CompositionWiseSaleReportComponent implements OnInit {
  model = new CompositionWiseSaleReport();
  CustomeId: any;
  itemArray: any[];
  ...
  close(item, action) {
    if (action == 'item') {
      ...
      this.chkBoxSelectedComposition.splice(this.selectedGroupName.indexOf(item), 1);
    }else if (action == 'mfg') {
