...
export class outstandingSupplierWise {
  public itemName: any;
  public group: string;
...
@Component({
  selector: 'app-report-payable-supplier-wise',
  templateUrl: './report-payable-supplier-wise.component.html',
  styleUrls: ['./report-payable-supplier-wise.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ReportPayableSupplierWiseComponent implements OnInit {
  model = new outstandingSupplierWise();
  CustomeId: any;
  itemArray: any[];
  supplierArray: any[];
