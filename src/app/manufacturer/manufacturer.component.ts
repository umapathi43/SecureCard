...
export class ManufacturerComponent implements OnInit {
  ...
  Confirm(data) {
    ...
    swal
      ...
      .then(function (result) {
        if (result.value) {
          data['status']="D";
          that._manfServcie.deleteManfactureById(data).subscribe((ok) => {
            swal.fire({
              icon: "success",
              title: "Deleted!",
  ...
  exportExcel() {
    ...
    this.saveAsExcelFile(excelBuffer, "maufacturers");
  }
